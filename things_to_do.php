...
if (isset($_GET ['u'])){
  // Get the username of the user
   $subject= mysql_real_escape_string($_GET['u']);
...
<div class="panel-heading">
    ...
    <h3 class="panel-title"><?php echo $subject; ?> check list</h3></div>
...
$grab_things = mysql_query("SELECT * FROM posts where for_grade= '$grade' && subject='$subject'");
...
<?php    if($deadline>=strtotime($date)){
